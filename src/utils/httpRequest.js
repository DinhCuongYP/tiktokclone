...
// try-catch là một cấu trúc điều khiển trong lập trình, được sử dụng để bắt các ngoại lệ (exceptions) được sinh ra trong quá trình thực thi chương trình. Khi có lỗi xảy ra trong khối try, quá trình thực thi chương trình sẽ được chuyển sang khối catch để xử lý ngoại lệ đó. Vì vậy, việc sử dụng try-catch là một cách để giúp chương trình chạy ổn định hơn và tránh gây ra sự cố khi xảy ra lỗi.
