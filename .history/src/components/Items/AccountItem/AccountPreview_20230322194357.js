        ...
        <div {...attrs} tabIndex="-1" className={cx({ [className]: className })}>
            <WrapperPopper className={cx('wrapper-preview')}>
                <div className={cx('preview-header')}>
                    ...
                    <Button onClick={loginModalShow} className={cx('btn-follow')} login>
                        Follow
                    </Button>
                </div>
                ...
                <footer className={cx('preview-footer')}>
                    <b className={cx('user_status')}>{followersCount}</b>
                    <span className={cx('user_status-title')}>Follower</span>

                    <b className={cx('user_status')}>{likesCount}</b>
                    <span className={cx('user_status-title')}>Thích</span>
